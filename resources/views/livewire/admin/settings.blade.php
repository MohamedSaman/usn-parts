        ...
        <div class="accordion-item border-0 mb-4 shadow-sm rounded-4">
            <h2 class="accordion-header" id="headingSystemConfigs">
                <button class="accordion-button fw-semibold bg-white text-dark rounded-4"
                    ...
                    <i class="bi bi-sliders fs-5 me-3 text-primary"></i>
                                        ...
                                        @foreach($settings as $setting)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-sm btn-outline-primary" wire:click="openEditModal({{ $setting->id }})">
                                                        <i class="bi bi-pencil"></i> Edit
                                                    </button>
                                                    <button class="btn btn-sm btn-outline-danger" wire:click="confirmDelete({{ $setting->id }})">
