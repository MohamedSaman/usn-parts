            ...
            <div class="card sticky-top" style="top: 20px;">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <div class="d-flex justify-content-between">
                            <span class="fw-bold">Allocated Payment:</span>
                            <span class="fw-bold text-success">Rs.{{ number_format($totalPaymentAmount, 2) }}</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="fw-bold">Remaining Due:</span>
                            <span class="fw-bold text-danger">Rs.{{ number_format($remainingAmount, 2) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2 mb-3">
                        <button class="btn btn-outline-primary btn-sm" wire:click="allocateRemainingAmount">
                            <i class="bi bi-arrow-right me-1"></i> Allocate Remaining Rs.{{ number_format($remainingAmount, 2) }}
                        </button>
                    </div>
                    @endif
                    ...
                    <div class="allocation-items">
                        ...
                        @if($allocation['due_amount'] > 0)
                        <div class="card mb-2 border-{{ $allocation['is_fully_paid'] ? 'success' : 'warning' }}">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="badge bg-{{ $allocation['is_fully_paid'] ? 'success' : 'warning' }}">
                                        Rs.{{ number_format($allocation['due_amount'], 2) }}
                                    </span>
                                </div>
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" 
                                           class="form-control" 
                                           wire:model.live="allocations.{{ $allocation['sale_id'] }}.payment_amount"
                                           min="0" 
                                           max="{{ $allocation['due_amount'] }}"
                                           step="0.01">
                                </div>
                                
                                <div class="d-flex gap-1 mt-2">
                                    <button class="btn btn-success btn-sm flex-fill" 
                                            wire:click="allocateFullPayment({{ $allocation['sale_id'] }})"
                                            {{ $allocation['is_fully_paid'] ? 'disabled' : '' }}>
                                        <i class="bi bi-check-lg"></i> Full
                                    </button>
                                    <button class="btn btn-outline-secondary btn-sm flex-fill" 
                                            wire:click="clearAllocation({{ $allocation['sale_id'] }})">
                    ...
                    <div class="d-grid mt-3">
                        <button class="btn btn-success btn-lg" 
                                ...
                                {{ $totalPaymentAmount <= 0 ? 'disabled' : '' }}>
                            <i class="bi bi-credit-card me-2"></i>
                            Process Payment - Rs.{{ number_format($totalPaymentAmount, 2) }}
                        </button>
                    </div>
                </div>
            </div>
