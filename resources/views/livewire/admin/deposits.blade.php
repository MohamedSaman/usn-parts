                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="text-center p-3 rounded" style="background-color: #d1ecf1;">
                                ...
                                <h5 class="fw-bold text-info">Rs. {{ number_format($openingCash + $todayCashAmount + $todayAdminCashAmount - $todayExpenses - $todayRefunds - $todayDepositAmount - $todaySupplierPayments, 2) }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
